...
#if !defined(RXCPP_OPERATORS_RX_MEMBERS_FULL_HPP)
#define RXCPP_OPERATORS_RX_MEMBERS_FULL_HPP
...
/*!
    \class rxcpp::observable_operators
...
class observable_operators
{
    ...
    using observable_root_type = observable_root<T, SourceOperator, Observable>;
    ...
    const observable_root_type& root() const {
        return *static_cast<observable_root_type const* const>(static_cast<observable_type const * const>(this));
    }
...
public:
    ...
    */
    ...
    auto filter(Predicate p) const
        ...
        -> decltype(EXPLICIT_THIS root().template lift<T>(rxo::detail::filter<T, Predicate>(std::move(p))))
        /// \endcond
    {
        return                    root().template lift<T>(rxo::detail::filter<T, Predicate>(std::move(p)));
    }
    ...
    */
    ...
    auto tap(MakeObserverArgN&&... an) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<T>(rxo::detail::tap<T, std::tuple<MakeObserverArgN...>>(std::make_tuple(std::forward<MakeObserverArgN>(an)...))))
        /// \endcond
    {
        return                    root().template lift<T>(rxo::detail::tap<T, std::tuple<MakeObserverArgN...>>(std::make_tuple(std::forward<MakeObserverArgN>(an)...)));
    }
    ...
    */
    ...
    auto finally(LastCall lc) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<T>(rxo::detail::finally<T, LastCall>(std::move(lc))))
        /// \endcond
    {
        return                    root().template lift<T>(rxo::detail::finally<T, LastCall>(std::move(lc)));
    }
    ...
    */
    ...
    auto on_error_resume_next(Selector s) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<rxu::value_type_t<rxo::detail::on_error_resume_next<T, Selector>>>(rxo::detail::on_error_resume_next<T, Selector>(std::move(s))))
        /// \endcond
    {
        return                    root().template lift<rxu::value_type_t<rxo::detail::on_error_resume_next<T, Selector>>>(rxo::detail::on_error_resume_next<T, Selector>(std::move(s)));
    }
    ...
    */
    ...
    auto map(Selector s) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<rxu::value_type_t<rxo::detail::map<T, Selector>>>(rxo::detail::map<T, Selector>(std::move(s))))
        /// \endcond
    {
        return                    root().template lift<rxu::value_type_t<rxo::detail::map<T, Selector>>>(rxo::detail::map<T, Selector>(std::move(s)));
    }
    ...
    */
    auto distinct_until_changed() const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<T>(rxo::detail::distinct_until_changed<T>()))
        /// \endcond
    {
        return                    root().template lift<T>(rxo::detail::distinct_until_changed<T>());
    }
    ...
    */
    auto window(int count) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<observable<T>>(rxo::detail::window<T>(count, count)))
        /// \endcond
    {
        return                    root().template lift<observable<T>>(rxo::detail::window<T>(count, count));
    }
    ...
    */
    auto window(int count, int skip) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<observable<T>>(rxo::detail::window<T>(count, skip)))
        /// \endcond
    {
        return                    root().template lift<observable<T>>(rxo::detail::window<T>(count, skip));
    }
    ...
    */
    ...
    auto window_with_time(Duration period, Duration skip, Coordination coordination) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<observable<T>>(rxo::detail::window_with_time<T, Duration, Coordination>(period, skip, coordination)))
        /// \endcond
    {
        return                    root().template lift<observable<T>>(rxo::detail::window_with_time<T, Duration, Coordination>(period, skip, coordination));
    }
    ...
    */
    ...
    auto window_with_time(Duration period, Duration skip) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<observable<T>>(rxo::detail::window_with_time<T, Duration, identity_one_worker>(period, skip, identity_current_thread())))
        /// \endcond
    {
        return                    root().template lift<observable<T>>(rxo::detail::window_with_time<T, Duration, identity_one_worker>(period, skip, identity_current_thread()));
    }
    ...
    */
    ...
    auto window_with_time(Duration period, Coordination coordination) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<observable<T>>(rxo::detail::window_with_time<T, Duration, Coordination>(period, period, coordination)))
        /// \endcond
    {
        return                    root().template lift<observable<T>>(rxo::detail::window_with_time<T, Duration, Coordination>(period, period, coordination));
    }
    ...
    */
    ...
    auto window_with_time(Duration period) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<observable<T>>(rxo::detail::window_with_time<T, Duration, identity_one_worker>(period, period, identity_current_thread())))
        /// \endcond
    {
        return                    root().template lift<observable<T>>(rxo::detail::window_with_time<T, Duration, identity_one_worker>(period, period, identity_current_thread()));
    }
    ...
    */
    ...
    auto window_with_time_or_count(Duration period, int count, Coordination coordination) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<observable<T>>(rxo::detail::window_with_time_or_count<T, Duration, Coordination>(period, count, coordination)))
        /// \endcond
    {
        return                    root().template lift<observable<T>>(rxo::detail::window_with_time_or_count<T, Duration, Coordination>(period, count, coordination));
    }
    ...
    */
    ...
    auto window_with_time_or_count(Duration period, int count) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<observable<T>>(rxo::detail::window_with_time_or_count<T, Duration, identity_one_worker>(period, count, identity_current_thread())))
        /// \endcond
    {
        return                    root().template lift<observable<T>>(rxo::detail::window_with_time_or_count<T, Duration, identity_one_worker>(period, count, identity_current_thread()));
    }
    ...
    */
    auto buffer(int count) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift_if<std::vector<T>>(rxo::detail::buffer_count<T>(count, count)))
        /// \endcond
    {
        return                    root().template lift_if<std::vector<T>>(rxo::detail::buffer_count<T>(count, count));
    }
    ...
    */
    auto buffer(int count, int skip) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift_if<std::vector<T>>(rxo::detail::buffer_count<T>(count, skip)))
        /// \endcond
    {
        return                    root().template lift_if<std::vector<T>>(rxo::detail::buffer_count<T>(count, skip));
    }
    ...
    */
    ...
    auto buffer_with_time(rxsc::scheduler::clock_type::duration period, rxsc::scheduler::clock_type::duration skip, Coordination coordination) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time<T, rxsc::scheduler::clock_type::duration, Coordination>(period, skip, coordination)))
        /// \endcond
    {
        return                    root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time<T, rxsc::scheduler::clock_type::duration, Coordination>(period, skip, coordination));
    }
    ...
    */
    auto buffer_with_time(rxsc::scheduler::clock_type::duration period, rxsc::scheduler::clock_type::duration skip) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time<T, rxsc::scheduler::clock_type::duration, identity_one_worker>(period, skip, identity_current_thread())))
        /// \endcond
    {
        return                    root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time<T, rxsc::scheduler::clock_type::duration, identity_one_worker>(period, skip, identity_current_thread()));
    }
    ...
    */
    ...
    auto buffer_with_time(rxsc::scheduler::clock_type::duration period, Coordination coordination) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time<T, rxsc::scheduler::clock_type::duration, Coordination>(period, period, coordination)))
        /// \endcond
    {
        return                    root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time<T, rxsc::scheduler::clock_type::duration, Coordination>(period, period, coordination));
    }
    ...
    */
    auto buffer_with_time(rxsc::scheduler::clock_type::duration period) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time<T, rxsc::scheduler::clock_type::duration, identity_one_worker>(period, period, identity_current_thread())))
        /// \endcond
    {
        return                    root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time<T, rxsc::scheduler::clock_type::duration, identity_one_worker>(period, period, identity_current_thread()));
    }
    ...
    */
    ...
    auto buffer_with_time_or_count(rxsc::scheduler::clock_type::duration period, int count, Coordination coordination) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time_or_count<T, rxsc::scheduler::clock_type::duration, Coordination>(period, count, coordination)))
        /// \endcond
    {
        return                    root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time_or_count<T, rxsc::scheduler::clock_type::duration, Coordination>(period, count, coordination));
    }
    ...
    */
    auto buffer_with_time_or_count(rxsc::scheduler::clock_type::duration period, int count) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time_or_count<T, rxsc::scheduler::clock_type::duration, identity_one_worker>(period, count, identity_current_thread())))
        /// \endcond
    {
        return                    root().template lift_if<std::vector<T>>(rxo::detail::buffer_with_time_or_count<T, rxsc::scheduler::clock_type::duration, identity_one_worker>(period, count, identity_current_thread()));
    }
    ...
    */
    auto switch_on_next() const
        ...
        /// \endcond
    {
        return      defer_switch_on_next<identity_one_worker>::make(cast(), cast(), identity_current_thread());
    }
    ...
    */
    ...
    auto switch_on_next(Coordination cn) const
        ...
        /// \endcond
    {
        return          defer_switch_on_next<Coordination>::make(cast(), cast(), std::move(cn));
    }
    ...
    */
    auto merge() const
        ...
        /// \endcond
    {
        return      defer_merge<identity_one_worker>::make(cast(), cast(), identity_current_thread());
    }
    ...
    */
    ...
    auto merge(Coordination cn) const
        ...
        /// \endcond
    {
        return          defer_merge<Coordination>::make(cast(), cast(), std::move(cn));
    }
    ...
    */
    ...
    auto merge(Value0 v0, ValueN... vn) const
        ...
        /// \endcond
    {
        return          defer_merge_from<identity_one_worker, Value0>::make(cast(), rxs::from(this->as_dynamic(), v0.as_dynamic(), vn.as_dynamic()...), identity_current_thread());
    }
    ...
    */
    ...
    auto merge(Coordination cn, Value0 v0, ValueN... vn) const
        ...
        /// \endcond
    {
        return          defer_merge_from<Coordination, Value0>::make(cast(), rxs::from(this->as_dynamic(), v0.as_dynamic(), vn.as_dynamic()...), std::move(cn));
    }
    ...
    */
    auto amb() const
        ...
        /// \endcond
    {
        return      defer_amb<identity_one_worker>::make(cast(), cast(), identity_current_thread());
    }
    ...
    */
    ...
    auto amb(Coordination cn) const
        ...
        /// \endcond
    {
        return          defer_amb<Coordination>::make(cast(), cast(), std::move(cn));
    }
    ...
    */
    ...
    auto amb(Value0 v0, ValueN... vn) const
        ...
        /// \endcond
    {
        return          defer_amb_from<identity_one_worker, Value0>::make(cast(), rxs::from(this->as_dynamic(), v0.as_dynamic(), vn.as_dynamic()...), identity_current_thread());
    }
    ...
    */
    ...
    auto amb(Coordination cn, Value0 v0, ValueN... vn) const
        ...
        /// \endcond
    {
        return          defer_amb_from<Coordination, Value0>::make(cast(), rxs::from(this->as_dynamic(), v0.as_dynamic(), vn.as_dynamic()...), std::move(cn));
    }
    ...
    */
    ...
    auto flat_map(CollectionSelector&& s, ResultSelector&& rs) const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<rxu::value_type_t<rxo::detail::flat_map<observable_type, CollectionSelector, ResultSelector, identity_one_worker>>,  rxo::detail::flat_map<observable_type, CollectionSelector, ResultSelector, identity_one_worker>>
        /// \endcond
    {
        return  observable<rxu::value_type_t<rxo::detail::flat_map<observable_type, CollectionSelector, ResultSelector, identity_one_worker>>,  rxo::detail::flat_map<observable_type, CollectionSelector, ResultSelector, identity_one_worker>>(
                                                                                                                                          rxo::detail::flat_map<observable_type, CollectionSelector, ResultSelector, identity_one_worker>(cast(), std::forward<CollectionSelector>(s), std::forward<ResultSelector>(rs), identity_current_thread()));
    }
    ...
    */
    ...
    auto flat_map(CollectionSelector&& s, ResultSelector&& rs, Coordination&& cn) const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<rxu::value_type_t<rxo::detail::flat_map<observable_type, CollectionSelector, ResultSelector, Coordination>>, rxo::detail::flat_map<observable_type, CollectionSelector, ResultSelector, Coordination>>
        /// \endcond
    {
        return  observable<rxu::value_type_t<rxo::detail::flat_map<observable_type, CollectionSelector, ResultSelector, Coordination>>, rxo::detail::flat_map<observable_type, CollectionSelector, ResultSelector, Coordination>>(
                                                                                                                                  rxo::detail::flat_map<observable_type, CollectionSelector, ResultSelector, Coordination>(cast(), std::forward<CollectionSelector>(s), std::forward<ResultSelector>(rs), std::forward<Coordination>(cn)));
    }
    ...
    */
    auto concat() const
        ...
        /// \endcond
    {
        return      defer_concat<identity_one_worker>::make(cast(), cast(), identity_current_thread());
    }
    ...
    */
    ...
    auto concat(Coordination cn) const
        ...
        /// \endcond
    {
        return          defer_concat<Coordination>::make(cast(), cast(), std::move(cn));
    }
    ...
    */
    ...
    auto concat(Value0 v0, ValueN... vn) const
        ...
        /// \endcond
    {
        return          defer_concat_from<identity_one_worker, Value0>::make(cast(), rxs::from(this->as_dynamic(), v0.as_dynamic(), vn.as_dynamic()...), identity_current_thread());
    }
    ...
    */
    ...
    auto concat(Coordination cn, Value0 v0, ValueN... vn) const
        ...
        /// \endcond
    {
        return          defer_concat_from<Coordination, Value0>::make(cast(), rxs::from(this->as_dynamic(), v0.as_dynamic(), vn.as_dynamic()...), std::move(cn));
    }
    ...
    */
    ...
    auto concat_map(CollectionSelector&& s, ResultSelector&& rs) const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<rxu::value_type_t<rxo::detail::concat_map<observable_type, CollectionSelector, ResultSelector, identity_one_worker>>,    rxo::detail::concat_map<observable_type, CollectionSelector, ResultSelector, identity_one_worker>>
        /// \endcond
    {
        return  observable<rxu::value_type_t<rxo::detail::concat_map<observable_type, CollectionSelector, ResultSelector, identity_one_worker>>,    rxo::detail::concat_map<observable_type, CollectionSelector, ResultSelector, identity_one_worker>>(
                                                                                                                                              rxo::detail::concat_map<observable_type, CollectionSelector, ResultSelector, identity_one_worker>(cast(), std::forward<CollectionSelector>(s), std::forward<ResultSelector>(rs), identity_current_thread()));
    }
    ...
    */
    ...
    auto concat_map(CollectionSelector&& s, ResultSelector&& rs, Coordination&& cn) const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<rxu::value_type_t<rxo::detail::concat_map<observable_type, CollectionSelector, ResultSelector, Coordination>>,   rxo::detail::concat_map<observable_type, CollectionSelector, ResultSelector, Coordination>>
        /// \endcond
    {
        return  observable<rxu::value_type_t<rxo::detail::concat_map<observable_type, CollectionSelector, ResultSelector, Coordination>>,   rxo::detail::concat_map<observable_type, CollectionSelector, ResultSelector, Coordination>>(
                                                                                                                                      rxo::detail::concat_map<observable_type, CollectionSelector, ResultSelector, Coordination>(cast(), std::forward<CollectionSelector>(s), std::forward<ResultSelector>(rs), std::forward<Coordination>(cn)));
    }
    ...
    */
    ...
    auto combine_latest(AN... an) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(select_combine_latest<observable_type, rxu::types<decltype(an)...>>{}(*(observable_type*)nullptr,  std::move(an)...))
        /// \endcond
    {
        return      select_combine_latest<observable_type, rxu::types<decltype(an)...>>{}(cast(),                 std::move(an)...);
    }
    ...
    */
    ...
    auto zip(AN... an) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(select_zip<observable_type, rxu::types<decltype(an)...>>{}(*(observable_type*)nullptr,  std::move(an)...))
        /// \endcond
    {
        return      select_zip<observable_type, rxu::types<decltype(an)...>>{}(cast(),                 std::move(an)...);
    }
    ...
    */
    ...
    inline auto group_by(KeySelector ks, MarbleSelector ms, BinaryPredicate p) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<typename rxo::detail::group_by_traits<T, observable_type, KeySelector, MarbleSelector, BinaryPredicate>::grouped_observable_type>(rxo::detail::group_by<T, observable_type, KeySelector, MarbleSelector, BinaryPredicate>(std::move(ks), std::move(ms), std::move(p))))
        /// \endcond
    {
        return                    root().template lift<typename rxo::detail::group_by_traits<T, observable_type, KeySelector, MarbleSelector, BinaryPredicate>::grouped_observable_type>(rxo::detail::group_by<T, observable_type, KeySelector, MarbleSelector, BinaryPredicate>(std::move(ks), std::move(ms), std::move(p)));
    }
    ...
    */
    ...
    inline auto group_by(KeySelector ks, MarbleSelector ms) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<typename rxo::detail::group_by_traits<T, observable_type, KeySelector, MarbleSelector, rxu::less>::grouped_observable_type>(rxo::detail::group_by<T, observable_type, KeySelector, MarbleSelector, rxu::less>(std::move(ks), std::move(ms), rxu::less())))
        /// \endcond
    {
        return                    root().template lift<typename rxo::detail::group_by_traits<T, observable_type, KeySelector, MarbleSelector, rxu::less>::grouped_observable_type>(rxo::detail::group_by<T, observable_type, KeySelector, MarbleSelector, rxu::less>(std::move(ks), std::move(ms), rxu::less()));
    }
    ...
    auto multicast(Subject sub) const
        ->      connectable_observable<T,   rxo::detail::multicast<T, observable_type, Subject>> {
        return  connectable_observable<T,   rxo::detail::multicast<T, observable_type, Subject>>(
                                            rxo::detail::multicast<T, observable_type, Subject>(cast(), std::move(sub)));
    }
    /// \endcond
    ...
    */
    ...
    auto subscribe_on(Coordination cn) const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<rxu::value_type_t<rxo::detail::subscribe_on<T, observable_type, Coordination>>,  rxo::detail::subscribe_on<T, observable_type, Coordination>>
        /// \endcond
    {
        return  observable<rxu::value_type_t<rxo::detail::subscribe_on<T, observable_type, Coordination>>,  rxo::detail::subscribe_on<T, observable_type, Coordination>>(
                                                                                                      rxo::detail::subscribe_on<T, observable_type, Coordination>(cast(), std::move(cn)));
    }
    ...
    */
    ...
    auto observe_on(Coordination cn) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<T>(rxo::detail::observe_on<T, Coordination>(std::move(cn))))
        /// \endcond
    {
        return                    root().template lift<T>(rxo::detail::observe_on<T, Coordination>(std::move(cn)));
    }
    ...
    */
        ...
        /// \endcond
    {
        return  observable<rxu::value_type_t<rxo::detail::reduce<T, source_operator_type, Accumulator, ResultSelector, Seed>>,    rxo::detail::reduce<T, source_operator_type, Accumulator, ResultSelector, Seed>>(
                                                                                                                                  rxo::detail::reduce<T, source_operator_type, Accumulator, ResultSelector, Seed>(cast().source_operator, std::forward<Accumulator>(a), std::forward<ResultSelector>(rs), seed));
    }
    ...
    */
    auto count() const
        ...
        /// \endcond
    {
        return      defer_reduce<int, rxu::count, rxu::defer_type<identity_for, int>>::make(cast().source_operator, rxu::count(), identity_for<int>(), 0);
    }
    ...
    */
    auto sum() const
        ...
        /// \endcond
    {
        return      defer_reduce<rxu::defer_seed_type<rxo::detail::sum, T>, rxu::defer_type<rxo::detail::sum, T>, rxu::defer_type<rxo::detail::sum, T>>::make(cast().source_operator, rxo::detail::sum<T>(), rxo::detail::sum<T>(), rxo::detail::sum<T>().seed());
    }
    ...
    */
    auto average() const
        ...
        /// \endcond
    {
        return      defer_reduce<rxu::defer_seed_type<rxo::detail::average, T>, rxu::defer_type<rxo::detail::average, T>, rxu::defer_type<rxo::detail::average, T>>::make(cast().source_operator, rxo::detail::average<T>(), rxo::detail::average<T>(), rxo::detail::average<T>().seed());
    }
    ...
    */
    ...
    auto scan(Seed seed, Accumulator&& a) const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<Seed,    rxo::detail::scan<T, observable_type, Accumulator, Seed>>
        /// \endcond
    {
        return  observable<Seed,    rxo::detail::scan<T, observable_type, Accumulator, Seed>>(
                                    rxo::detail::scan<T, observable_type, Accumulator, Seed>(cast(), std::forward<Accumulator>(a), seed));
    }
    ...
    */
    ...
    auto skip(Count t) const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<T,   rxo::detail::skip<T, observable_type, Count>>
        /// \endcond
    {
        return  observable<T,   rxo::detail::skip<T, observable_type, Count>>(
                                rxo::detail::skip<T, observable_type, Count>(cast(), t));
    }
    ...
    */
    ...
    auto skip_until(TriggerSource&& t) const
        ...
        -> typename std::enable_if<is_observable<TriggerSource>::value,
                observable<T,   rxo::detail::skip_until<T, observable_type, TriggerSource, identity_one_worker>>>::type
        /// \endcond
    {
        return  observable<T,   rxo::detail::skip_until<T, observable_type, TriggerSource, identity_one_worker>>(
                                rxo::detail::skip_until<T, observable_type, TriggerSource, identity_one_worker>(cast(), std::forward<TriggerSource>(t), identity_one_worker(rxsc::make_current_thread())));
    }
    ...
    */
    ...
    auto skip_until(TriggerSource&& t, Coordination&& cn) const
        ...
        -> typename std::enable_if<is_observable<TriggerSource>::value && is_coordination<Coordination>::value,
                observable<T,   rxo::detail::skip_until<T, observable_type, TriggerSource, Coordination>>>::type
        /// \endcond
    {
        return  observable<T,   rxo::detail::skip_until<T, observable_type, TriggerSource, Coordination>>(
                                rxo::detail::skip_until<T, observable_type, TriggerSource, Coordination>(cast(), std::forward<TriggerSource>(t), std::forward<Coordination>(cn)));
    }
    ...
    */
    ...
    auto take(Count t) const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<T,   rxo::detail::take<T, observable_type, Count>>
        /// \endcond
    {
        return  observable<T,   rxo::detail::take<T, observable_type, Count>>(
                                rxo::detail::take<T, observable_type, Count>(cast(), t));
    }
    ...
    */
    ...
    auto take_until(TriggerSource t) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> typename std::enable_if<is_observable<TriggerSource>::value,
                observable<T,   rxo::detail::take_until<T, observable_type, TriggerSource, identity_one_worker>>>::type
        /// \endcond
    {
        return  observable<T,   rxo::detail::take_until<T, observable_type, TriggerSource, identity_one_worker>>(
                                rxo::detail::take_until<T, observable_type, TriggerSource, identity_one_worker>(cast(), std::move(t), identity_current_thread()));
    }
    ...
    */
    ...
    auto take_until(TriggerSource t, Coordination cn) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> typename std::enable_if<is_observable<TriggerSource>::value && is_coordination<Coordination>::value,
                observable<T,   rxo::detail::take_until<T, observable_type, TriggerSource, Coordination>>>::type
        /// \endcond
    {
        return  observable<T,   rxo::detail::take_until<T, observable_type, TriggerSource, Coordination>>(
                                rxo::detail::take_until<T, observable_type, TriggerSource, Coordination>(cast(), std::move(t), std::move(cn)));
    }
    ...
    */
    ...
    auto take_until(TimePoint when) const
        ...
        -> typename std::enable_if<std::is_convertible<TimePoint, rxsc::scheduler::clock_type::time_point>::value,
                observable<T,   rxo::detail::take_until<T, observable_type, decltype(rxs::timer(when, identity_current_thread())), identity_one_worker>>>::type
        /// \endcond
    {
    ...
    */
    ...
    auto take_until(rxsc::scheduler::clock_type::time_point when, Coordination cn) const
        ...
        -> typename std::enable_if<is_coordination<Coordination>::value,
                observable<T,   rxo::detail::take_until<T, observable_type, decltype(rxs::timer(when, cn)), Coordination>>>::type
        /// \endcond
    {
        return  take_until(rxs::timer(when, cn), cn);
    }
    ...
    */
    auto repeat() const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<T, rxo::detail::repeat<T, observable_type, int>>
        /// \endcond
    {
        return  observable<T, rxo::detail::repeat<T, observable_type, int>>(
            rxo::detail::repeat<T, observable_type, int>(cast(), 0));
    }
    ...
    */
    ...
    auto repeat(Count t) const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<T, rxo::detail::repeat<T, observable_type, Count>>
        /// \endcond
    {
        return  observable<T, rxo::detail::repeat<T, observable_type, Count>>(
            rxo::detail::repeat<T, observable_type, Count>(cast(), t));
    }
    ...
    */
    auto retry() const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<T, rxo::detail::retry<T, observable_type, int>>
        /// \endcond
    {
        return  observable<T, rxo::detail::retry<T, observable_type, int>>(
            rxo::detail::retry<T, observable_type, int>(cast(), 0));
    }
    ...
    */
    ...
    auto retry(Count t) const
        /// \cond SHOW_SERVICE_MEMBERS
        ->      observable<T, rxo::detail::retry<T, observable_type, Count>>
        /// \endcond
    {
        return  observable<T, rxo::detail::retry<T, observable_type, Count>>(
            rxo::detail::retry<T, observable_type, Count>(cast(), t));
    }
    ...
    */
    ...
    auto start_with(Value0 v0, ValueN... vn) const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(rxo::start_with(*(observable_type*)nullptr, std::move(v0), std::move(vn)...))
        /// \endcond
    {
        return      rxo::start_with(cast(), std::move(v0), std::move(vn)...);
    }
    ...
    */
    auto pairwise() const
        /// \cond SHOW_SERVICE_MEMBERS
        -> decltype(EXPLICIT_THIS root().template lift<rxu::value_type_t<rxo::detail::pairwise<T>>>(rxo::detail::pairwise<T>()))
        /// \endcond
    {
        return                    root().template lift<rxu::value_type_t<rxo::detail::pairwise<T>>>(rxo::detail::pairwise<T>());
    }
};

template<class T, class SourceOperator, class Observable>
auto observable_operators<T, SourceOperator, Observable>::last() const
    -> observable<T> {
    rxu::maybe<T> seed;
    return cast()->reduce(
        seed,
...
template<class T, class SourceOperator, class Observable>
auto observable_operators<T, SourceOperator, Observable>::first() const
    -> observable<T> {
    rxu::maybe<T> seed;
    return cast()->take(1).reduce(
        seed,
        [](rxu::maybe<T>, T t){return rxu::maybe<T>(std::move(t));},
